...
class SituacaoAvaliacaosControllerTest < ActionController::TestCase
  setup do
    @situacao_avaliacao = situacao_avaliacaos(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:situacao_avaliacaos)
  end
  ...
  test "should destroy situacao_avaliacao" do
    ...
    assert_redirected_to situacao_avaliacaos_path
  end
end
